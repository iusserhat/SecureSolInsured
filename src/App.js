...
var renew = false;
var mytime;
const programID = new PublicKey("7yqvgTivqqjQYFLrautXZ336TZF9uCr2y7ciKLjmha7V");
...
function App() {
  ...
  async function subnow() {
        ...
        var [myacc] = await web3.PublicKey.findProgramAddressSync([Buffer.from("sol"), provider.wallet.publicKey.toBuffer()], programID);
          ...
          console.log("come here xx!");
            ...
            try {
              ...
              const tx = await program.rpc.renew(cprice, {
                accounts: {
                 buyer: myacc,
                  receiver: new PublicKey('2zjstJ8iXTKKPi5EBM6G4qbtcfqbmWeXEqeVCNHrpZ25'),
        ...
        if (!wallet.connected) {
            ...
            <Container>
             <Row>
               <Col>
                         ...
                         {<center><p className=""> Get insured now and be safe </p></center>}
          ...
          return (
            ...
            <div className="App">
              <div>
              { <center> <img className="App-logo" src={logo} /> </center> }
                {<h2 id="swtab"> Get Insured Now </h2>}
                <h5>Insured type</h5>
<select id="insurance-type" name="insurance-type">
    <option value="sağlık">Health insurance</option>
    <option value="seyahat">Travel insurance</option>
    <option value="konut"> Home insurance</option>
